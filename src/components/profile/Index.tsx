...
import ProfileImage from "../../image/profile_img.png";
    ...
    <div className="w-full flex flex-col w-full gap-50 px-20 py-20">
      ...
      >
        <img
          src={ProfileImage}
          alt="user_profile"
          className="border-5 rounded-full border-purple h-150 w-150"
        />
        <div className="sm:grid col-2 color-white text-right col-gap-50  space-y-10 sm:text-regular">
          ...
          <div className="hidden sm:visible color-gray">Signup Email</div>{" "}
